...
svg("res_hybrid.svg", width = 7, height = 3)
...
plot(map, col = c(rgb(255,255,68,trans_drought,maxColorValue = 255),
                  ...
                  rgb(121,0,0,trans_drought,maxColorValue = 255)), border = 'grey30')


points(res,cex = (capacity/4552000)*10,col = 'grey30', lwd=2)
points(res,cex = (storage/4552000)*10, pch = 16,
       col = rgb(0,0,200,trans_drought,maxColorValue = 255), 
       bg = rgb(0,0,200,trans_drought,maxColorValue = 255))
